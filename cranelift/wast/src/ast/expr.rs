...
instructions! {
    pub enum Instruction<'a> {
        ...
        //constant-time
        DropCT : [0xfb,0x1a] : "drop.ct",
        SelectCT(SelectTypes<'a>) : [0xfb] : "select.ct",
        LocalGetCT(ast::Index<'a>) : [0xfb,0x20] : "local.get.ct" | "get_local.ct",
        LocalSetCT(ast::Index<'a>) : [0xfb,0x21] : "local.set.ct" | "set_local.ct",
        LocalTeeCT(ast::Index<'a>) : [0xfb,0x22] : "local.tee.ct" | "tee_local.ct",
        GlobalGetCT(ast::IndexOrRef<'a, kw::global>) : [0xfb,0x23] : "global.get.ct" | "get_global.ct",
        GlobalSetCT(ast::IndexOrRef<'a, kw::global>) : [0xfb,0x24] : "global.set.ct" | "set_global.ct",

        I32LoadCT(MemArg<4>) : [0xfb,0x28] : "i32.load.ct",
        I64LoadCT(MemArg<8>) : [0xfb,0x29] : "i64.load.ct",
        I32Load8sCT(MemArg<1>) : [0xfb,0x2c] : "i32.load8_s.ct",
        I32Load8uCT(MemArg<1>) : [0xfb,0x2d] : "i32.load8_u.ct",
        I32Load16sCT(MemArg<2>) : [0xfb,0x2e] : "i32.load16_s.ct",
        I32Load16uCT(MemArg<2>) : [0xfb,0x2f] : "i32.load16_u.ct",
        I64Load8sCT(MemArg<1>) : [0xfb,0x30] : "i64.load8_s.ct",
        I64Load8uCT(MemArg<1>) : [0xfb,0x31] : "i64.load8_u.ct",
        I64Load16sCT(MemArg<2>) : [0xfb,0x32] : "i64.load16_s.ct",
        I64Load16uCT(MemArg<2>) : [0xfb,0x33] : "i64.load16_u.ct",
        I64Load32sCT(MemArg<4>) : [0xfb,0x34] : "i64.load32_s.ct",
        I64Load32uCT(MemArg<4>) : [0xfb,0x35] : "i64.load32_u.ct",
        I32StoreCT(MemArg<4>) : [0xfb,0x36] : "i32.store.ct",
        I64StoreCT(MemArg<8>) : [0xfb,0x37] : "i64.store.ct",
        I32Store8CT(MemArg<1>) : [0xfb,0x3a] : "i32.store8.ct",
        I32Store16CT(MemArg<2>) : [0xfb,0x3b] : "i32.store16.ct",
        I64Store8CT(MemArg<1>) : [0xfb,0x3c] : "i64.store8.ct",
        I64Store16CT(MemArg<2>) : [0xfb,0x3d] : "i64.store16.ct",
        I64Store32CT(MemArg<4>) : [0xfb,0x3e] : "i64.store32.ct",

        I32ConstCT(i32) : [0xfb,0x41] : "i32.const.ct",
        I64ConstCT(i64) : [0xfb,0x42] : "i64.const.ct",

        I32ClzCT : [0xfb,0x67] : "i32.clz.ct",
        I32CtzCT : [0xfb,0x68] : "i32.ctz.ct",
        I32PopcntCT : [0xfb,0x69] : "i32.popcnt.ct",
        I32AddCT : [0xfb,0x6a] : "i32.add.ct",
        I32SubCT : [0xfb,0x6b] : "i32.sub.ct",
        I32MulCT : [0xfb,0x6c] : "i32.mul.ct",
        I32DivSCT : [0xfb,0x6d] : "i32.div_s.ct",
        I32DivUCT : [0xfb,0x6e] : "i32.div_u.ct",
        I32RemSCT : [0xfb,0x6f] : "i32.rem_s.ct",
        I32RemUCT : [0xfb,0x70] : "i32.rem_u.ct",
        I32AndCT : [0xfb,0x71] : "i32.and.ct",
        I32OrCT : [0xfb,0x72] : "i32.or.ct",
        I32XorCT : [0xfb,0x73] : "i32.xor.ct",
        I32ShlCT : [0xfb,0x74] : "i32.shl.ct",
        I32ShrSCT : [0xfb,0x75] : "i32.shr_s.ct",
        I32ShrUCT : [0xfb,0x76] : "i32.shr_u.ct",
        I32RotlCT : [0xfb,0x77] : "i32.rotl.ct",
        I32RotrCT : [0xfb,0x78] : "i32.rotr.ct",

        I64ClzCT : [0xfb,0x79] : "i64.clz.ct",
        I64CtzCT : [0xfb,0x7a] : "i64.ctz.ct",
        I64PopcntCT : [0xfb,0x7b] : "i64.popcnt.ct",
        I64AddCT : [0xfb,0x7c] : "i64.add.ct",
        I64SubCT : [0xfb,0x7d] : "i64.sub.ct",
        I64MulCT : [0xfb,0x7e] : "i64.mul.ct",
        I64DivSCT : [0xfb,0x7f] : "i64.div_s.ct",
        I64DivUCT : [0xfb,0x80] : "i64.div_u.ct",
        I64RemSCT : [0xfb,0x81] : "i64.rem_s.ct",
        I64RemUCT : [0xfb,0x82] : "i64.rem_u.ct",
        I64AndCT : [0xfb,0x83] : "i64.and.ct",
        I64OrCT : [0xfb,0x84] : "i64.or.ct",
        I64XorCT : [0xfb,0x85] : "i64.xor.ct",
        I64ShlCT : [0xfb,0x86] : "i64.shl.ct",
        I64ShrSCT : [0xfb,0x87] : "i64.shr_s.ct",
        I64ShrUCT : [0xfb,0x88] : "i64.shr_u.ct",
        I64RotlCT : [0xfb,0x89] : "i64.rotl.ct",
        I64RotrCT : [0xfb,0x8a] : "i64.rotr.ct",

        I32EqzCT : [0xfb,0x45] : "i32.eqz.ct",
        I32EqCT : [0xfb,0x46] : "i32.eq.ct",
        I32NeCT : [0xfb,0x47] : "i32.ne.ct",
        I32LtSCT : [0xfb,0x48] : "i32.lt_s.ct",
        I32LtUCT : [0xfb,0x49] : "i32.lt_u.ct",
        I32GtSCT : [0xfb,0x4a] : "i32.gt_s.ct",
        I32GtUCT : [0xfb,0x4b] : "i32.gt_u.ct",
        I32LeSCT : [0xfb,0x4c] : "i32.le_s.ct",
        I32LeUCT : [0xfb,0x4d] : "i32.le_u.ct",
        I32GeSCT : [0xfb,0x4e] : "i32.ge_s.ct",
        I32GeUCT : [0xfb,0x4f] : "i32.ge_u.ct",

        I64EqzCT : [0xfb,0x50] : "i64.eqz.ct",
        I64EqCT : [0xfb,0x51] : "i64.eq.ct",
        I64NeCT : [0xfb,0x52] : "i64.ne.ct",
        I64LtSCT : [0xfb,0x53] : "i64.lt_s.ct",
        I64LtUCT : [0xfb,0x54] : "i64.lt_u.ct",
        I64GtSCT : [0xfb,0x55] : "i64.gt_s.ct",
        I64GtUCT : [0xfb,0x56] : "i64.gt_u.ct",
        I64LeSCT : [0xfb,0x57] : "i64.le_s.ct",
        I64LeUCT : [0xfb,0x58] : "i64.le_u.ct",
        I64GeSCT : [0xfb,0x59] : "i64.ge_s.ct",
        I64GeUCT : [0xfb,0x5a] : "i64.ge_u.ct",

        I32WrapI64CT : [0xfb,0xa7] : "i32.wrap_i64.ct" | "i32.wrap/i64.ct",
        I64ExtendI32SCT : [0xfb,0xac] : "i64.extend_i32_s.ct" | "i64.extend_s/i32.ct",
        I64ExtendI32UCT : [0xfb,0xad] : "i64.extend_i32_u.ct" | "i64.extend_u/i32.ct",
        I32Extend8SCT : [0xfb,0xc0] : "i32.extend8_s.ct",
        I32Extend16SCT : [0xfb,0xc1] : "i32.extend16_s.ct",
        I64Extend8SCT : [0xfb,0xc2] : "i64.extend8_s.ct",
        I64Extend16SCT : [0xfb,0xc3] : "i64.extend16_s.ct",
        I64Extend32SCT : [0xfb,0xc4] : "i64.extend32_s.ct",
